...
var Dom = _interopRequireWildcard(dom);



var _window2 = _interopRequireDefault(window_1);
...
var obj = createCommonjsModule(function (module, exports) {
'use strict';
...
function _interopRequireDefault(obj$$1) { return obj$$1 && obj$$1.__esModule ? obj$$1 : { 'default': obj$$1 }; }
...
var logByType = exports.logByType = function logByType(type, args) {
  var stringify = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !!browser.IE_VERSION && browser.IE_VERSION < 11;
  ...
  if (stringify) {
    args = args.map(function (a) {
      if ((0, obj.isObject)(a) || Array.isArray(a)) {
        try {
...
var Guid = _interopRequireWildcard(guid);



var _log2 = _interopRequireDefault(log_1);



var _tsml2 = _interopRequireDefault(tsml);



function _interopRequireWildcard(obj$$1) { if (obj$$1 && obj$$1.__esModule) { return obj$$1; } else { var newObj = {}; if (obj$$1 != null) { for (var key in obj$$1) { if (Object.prototype.hasOwnProperty.call(obj$$1, key)) newObj[key] = obj$$1[key]; } } newObj['default'] = obj$$1; return newObj; } }
 ...
 */
function isEl(value) {
  return (0, obj.isObject)(value) && value.nodeType === 1;
}
...
function isTextNode(value) {
  return (0, obj.isObject)(value) && value.nodeType === 3;
}
...
var Events = _interopRequireWildcard(events);
...
var fn = createCommonjsModule(function (module, exports) {
'use strict';
...
var mergeOptions_1 = createCommonjsModule(function (module, exports) {
'use strict';
...
function mergeOptions() {
  ...
  sources.forEach(function (source) {
    ...
    (0, obj.each)(source, function (value, key) {
      if (!(0, obj.isPlain)(value)) {
        result[key] = value;
        return;
      }

      if (!(0, obj.isPlain)(result[key])) {
        result[key] = {};
      }
...
var Fn = _interopRequireWildcard(fn);
...
var _toTitleCase2 = _interopRequireDefault(toTitleCase_1);



var _mergeOptions2 = _interopRequireDefault(mergeOptions_1);
...
var Component = function () {
  ...
  Component.prototype.on = function on(first, second, third) {
    ...
    if (typeof first === 'string' || Array.isArray(first)) {
      ...
      var target = first;
      var type = second;
      var fn$$1 = Fn.bind(this, third);

      // When this component is disposed, remove the listener from the other component
      var removeOnDispose = function removeOnDispose() {
        return _this2.off(target, type, fn$$1);
      };

      // Use the same function ID so we can remove it later it using the ID
      // of the original listener
      removeOnDispose.guid = fn$$1.guid;
      ...
      cleanRemover.guid = fn$$1.guid;

      // Check if this is a DOM node
      if (first.nodeName) {
        // Add the listener to the other element
        Events.on(target, type, fn$$1);
  ...
  Component.prototype.off = function off(first, second, third) {
    if (!first || typeof first === 'string' || Array.isArray(first)) {
      ...
      this.off('dispose', fn$$1);

      if (first.nodeName) {
        // Remove the listener
        Events.off(target, type, fn$$1);
        // Remove the listener for cleaning the dispose listener
        Events.off(target, 'dispose', fn$$1);
      } else {
        target.off(type, fn$$1);
        target.off('dispose', fn$$1);
      }
    }
  ...
  Component.prototype.one = function one(first, second, third) {
    ...
    if (typeof first === 'string' || Array.isArray(first)) {
      ...
      var newFunc = function newFunc() {
        ...
        fn$$1.apply(null, _arguments);
      };

      // Keep the same function ID so we can remove it later
      newFunc.guid = fn$$1.guid;
  ...
  Component.prototype.ready = function ready(fn$$1) {
    ...
    if (fn$$1) {
      if (this.isReady_) {
        if (sync) {
          ...
          this.setTimeout(fn$$1, 1);
        }
      } else {
        this.readyQueue_ = this.readyQueue_ || [];
        this.readyQueue_.push(fn$$1);
      }
    }
    return this;
  };
  ...
  Component.prototype.triggerReady = function triggerReady() {
    ...
    this.setTimeout(function () {
      ...
      if (readyQueue && readyQueue.length > 0) {
        readyQueue.forEach(function (fn$$1) {
          fn$$1.call(this);
        }, this);
      }
  ...
  Component.prototype.setTimeout = function setTimeout(fn$$1, timeout) {
    fn$$1 = Fn.bind(this, fn$$1);

    var timeoutId = _window2['default'].setTimeout(fn$$1, timeout);
  ...
  Component.prototype.setInterval = function setInterval(fn$$1, interval) {
    fn$$1 = Fn.bind(this, fn$$1);

    var intervalId = _window2['default'].setInterval(fn$$1, interval);
...
var timeRanges = createCommonjsModule(function (module, exports) {
'use strict';
...
function bufferedPercent(buffered, duration) {
  ...
  if (!buffered || !buffered.length) {
    buffered = (0, timeRanges.createTimeRange)(0, 0);
  }
...
var fullscreenApi = createCommonjsModule(function (module, exports) {
'use strict';
...
var mediaError = createCommonjsModule(function (module, exports) {
'use strict';
...
var textTrackListConverter = createCommonjsModule(function (module, exports) {
'use strict';
...
var modalDialog = createCommonjsModule(function (module, exports) {
'use strict';
...
var _component2 = _interopRequireDefault(component);
...
var textTrackCueList = createCommonjsModule(function (module, exports) {
'use strict';
...
var browser$$1 = _interopRequireWildcard(browser);
...
var trackEnums = createCommonjsModule(function (module, exports) {
'use strict';
...
var parseHeaders = function (headers) {
  ...
  index$6(
      index$4(headers).split('\n')
    , function (row) {
        var index = row.indexOf(':')
          , key = index$4(row.slice(0, index)).toLowerCase()
          , value = index$4(row.slice(index + 1));
...
var textTrack = createCommonjsModule(function (module, exports) {
'use strict';
...
var _textTrackCueList2 = _interopRequireDefault(textTrackCueList);
...
var _xhr2 = _interopRequireDefault(index);
 ...
 * @private
 */
var parseCues = function parseCues(srcContent, track$$1) {
  ...
  if (errors.length > 0) {
    if (_window2['default'].console && _window2['default'].console.groupCollapsed) {
      _window2['default'].console.groupCollapsed('Text Track parsing errors for ' + track$$1.src);
    }
 ...
 * @private
 */
var loadTrack = function loadTrack(src, track$$1) {
  var opts = {
    uri: src
  };
  var crossOrigin = (0, url.isCrossOrigin)(src);
    ...
    if (typeof _window2['default'].WebVTT !== 'function') {
      if (track$$1.tech_) {
        var loadHandler = function loadHandler() {
          return parseCues(responseBody, track$$1);
        };

        track$$1.tech_.on('vttjsloaded', loadHandler);
        track$$1.tech_.on('vttjserror', function () {
          _log2['default'].error('vttjs failed to load, stopping trying to process ' + track$$1.src);
          track$$1.tech_.off('vttjsloaded', loadHandler);
        });
      }
    } else {
      parseCues(responseBody, track$$1);
    }
  }));
};
...
var TextTrack = function (_Track) {
  ...
  function TextTrack() {
    ...
    var mode = trackEnums.TextTrackMode[settings.mode] || 'disabled';
...
var htmlTrackElement = createCommonjsModule(function (module, exports) {
'use strict';
...
var _textTrack2 = _interopRequireDefault(textTrack);
...
var htmlTrackElementList = createCommonjsModule(function (module, exports) {
'use strict';
...
var trackList = createCommonjsModule(function (module, exports) {
'use strict';
...
var textTrackList = createCommonjsModule(function (module, exports) {
'use strict';
...
var _trackList2 = _interopRequireDefault(trackList);
...
var videoTrackList = createCommonjsModule(function (module, exports) {
'use strict';
...
var audioTrackList = createCommonjsModule(function (module, exports) {
'use strict';
...
var vtt = createCommonjsModule(function (module, exports) {
...
var tech = createCommonjsModule(function (module, exports) {
'use strict';
...
var _htmlTrackElement2 = _interopRequireDefault(htmlTrackElement);



var _htmlTrackElementList2 = _interopRequireDefault(htmlTrackElementList);
...
var _textTrackList2 = _interopRequireDefault(textTrackList);



var _videoTrackList2 = _interopRequireDefault(videoTrackList);



var _audioTrackList2 = _interopRequireDefault(audioTrackList);
...
var _mediaError2 = _interopRequireDefault(mediaError);
...
var Tech = function (_Component) {
  ...
  Tech.prototype.buffered = function buffered() {
    return (0, timeRanges.createTimeRange)(0, 0);
  };
  ...
  Tech.prototype.bufferedPercent = function bufferedPercent() {
    return (0, buffer.bufferedPercent)(this.buffered(), this.duration_);
  };
  ...
  Tech.prototype.played = function played() {
    ...
    return (0, timeRanges.createTimeRange)();
  };
  ...
  Tech.prototype.addWebVttScript_ = function addWebVttScript_() {
    ...
    if (_document2['default'].body.contains(this.el())) {
      ...
      if (!this.options_['vtt.js'] && (0, obj.isPlain)(vtt$$1) && Object.keys(vtt$$1).length > 0) {
  ...
  Tech.prototype.addRemoteTextTrack = function addRemoteTextTrack() {
    ...
    var htmlTrackElement$$1 = this.createRemoteTextTrack(options);
    ...
    this.remoteTextTrackEls().addTrackElement_(htmlTrackElement$$1);
    this.remoteTextTracks().addTrack_(htmlTrackElement$$1.track);

    if (manualCleanup !== true) {
      // create the TextTrackList if it doesn't exist
      this.autoRemoteTextTracks_.addTrack_(htmlTrackElement$$1.track);
    }

    return htmlTrackElement$$1;
  };
  ...
  Tech.isTech = function isTech(component$$1) {
    return component$$1.prototype instanceof Tech || component$$1 instanceof Tech || component$$1 === Tech;
  };
...
var _tech2 = _interopRequireDefault(tech);
  ...
  function MediaLoader(player, options, ready) {
    ...
    if (!options.playerOptions.sources || options.playerOptions.sources.length === 0) {
      for (var i = 0, j = options.playerOptions.techOrder; i < j.length; i++) {
        ...
        var tech$$1 = _tech2['default'].getTech(techName);

        // Support old behavior of techs being registered as components.
        // Remove once that deprecated behavior is removed.
        if (!techName) {
          tech$$1 = _component2['default'].getComponent(techName);
        }

        // Check if the browser supports this technology
        if (tech$$1 && tech$$1.isSupported()) {
...
var flashRtmp = createCommonjsModule(function (module, exports) {
'use strict';
...
var Url = _interopRequireWildcard(url);





var _flashRtmp2 = _interopRequireDefault(flashRtmp);
...
var Flash = function (_Tech) {
  ...
  Flash.prototype.seekable = function seekable() {
    ...
    return (0, timeRanges.createTimeRange)(0, duration);
  };
  ...
  Flash.prototype.buffered = function buffered() {
    ...
    return (0, timeRanges.createTimeRange)(ranges[0][0], ranges[0][1]);
  };
 ...
 *        The options to pass to the source
 */
Flash.nativeSourceHandler.handleSource = function (source, tech$$1, options) {
  tech$$1.setSrc(source.src);
};
...
Flash.onReady = function (currSwf) {
  ...
  var tech$$1 = el && el.tech;

  // if there is no el then the tech has been disposed
  // and the tech element was removed from the player div
  if (tech$$1 && tech$$1.el()) {
    // check that the flash object is really ready
    Flash.checkReady(tech$$1);
  }
};
 ...
 */
Flash.checkReady = function (tech$$1) {
...
Flash.onEvent = function (swfID, eventName) {
  var tech$$1 = Dom.getEl(swfID).tech;
  ...
  tech$$1.setTimeout(function () {
    tech$$1.trigger(eventName, args);
  }, 1);
};
...
Flash.onError = function (swfID, err) {
  ...
  if (err === 'srcnotfound') {
    return tech$$1.error(4);
  }

  // trigger a custom error
  tech$$1.error('FLASH: ' + err);
};
...
Flash.embed = function (swf, flashVars, params, attributes) {
  ...
  var obj$$1 = Dom.createEl('div', { innerHTML: code }).childNodes[0];
...
var clickableComponent = createCommonjsModule(function (module, exports) {
'use strict';
...
var posterImage = createCommonjsModule(function (module, exports) {
'use strict';
...
var _clickableComponent2 = _interopRequireDefault(clickableComponent);
...
var PosterImage = function (_ClickableComponent) {
  ...
  PosterImage.prototype.createEl = function createEl() {
    ...
    // img element.
    if (!browser$$1.BACKGROUND_SIZE_SUPPORTED) {
...
var textTrackDisplay = createCommonjsModule(function (module, exports) {
'use strict';
...
var loadingSpinner = createCommonjsModule(function (module, exports) {
'use strict';
...
var bigPlayButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var closeButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var playToggle = createCommonjsModule(function (module, exports) {
'use strict';
...
var currentTimeDisplay = createCommonjsModule(function (module, exports) {
'use strict';
...
var _formatTime2 = _interopRequireDefault(formatTime_1);
...
var durationDisplay = createCommonjsModule(function (module, exports) {
'use strict';
...
var timeDivider = createCommonjsModule(function (module, exports) {
'use strict';
...
var remainingTimeDisplay = createCommonjsModule(function (module, exports) {
'use strict';
...
var liveDisplay = createCommonjsModule(function (module, exports) {
'use strict';
...
var computedStyle_1 = createCommonjsModule(function (module, exports) {
'use strict';
...
var loadProgressBar = createCommonjsModule(function (module, exports) {
'use strict';
...
var playProgressBar = createCommonjsModule(function (module, exports) {
'use strict';
...
var tooltipProgressBar = createCommonjsModule(function (module, exports) {
'use strict';
...
var seekBar = createCommonjsModule(function (module, exports) {
'use strict';
...
var _computedStyle2 = _interopRequireDefault(computedStyle_1);
...
var mouseTimeDisplay = createCommonjsModule(function (module, exports) {
'use strict';
...
var progressControl = createCommonjsModule(function (module, exports) {
'use strict';
...
var fullscreenToggle = createCommonjsModule(function (module, exports) {
'use strict';
...
var volumeLevel = createCommonjsModule(function (module, exports) {
'use strict';
...
var volumeBar = createCommonjsModule(function (module, exports) {
'use strict';
...
var volumeControl = createCommonjsModule(function (module, exports) {
'use strict';
...
var Popup = function (_Component) {
   ...
   *
   */
  Popup.prototype.addItem = function addItem(component$$1) {
    this.addChild(component$$1);
    component$$1.on('click', Fn.bind(this, function () {
      this.unlockShowing();
    }));
  };
...
var popupButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var muteToggle = createCommonjsModule(function (module, exports) {
'use strict';
...
var volumeMenuButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var _popup2 = _interopRequireDefault(popup);



var _popupButton2 = _interopRequireDefault(popupButton);



var _muteToggle2 = _interopRequireDefault(muteToggle);



var _volumeBar2 = _interopRequireDefault(volumeBar);
...
var VolumeMenuButton = function (_PopupButton) {
  ...
  VolumeMenuButton.prototype.createPopup = function createPopup() {
    var popup$$1 = new _popup2['default'](this.player_, {
      contentElType: 'div'
    });
...
var Menu = function (_Component) {
  ...
  Menu.prototype.addItem = function addItem(component$$1) {
    this.addChild(component$$1);
    component$$1.on('click', Fn.bind(this, function (event) {
      this.unlockShowing();
...
var menuButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var MenuButton = function (_ClickableComponent) {
  ...
  MenuButton.prototype.createMenu = function createMenu() {
    var menu$$1 = new _menu2['default'](this.player_);
    ...
    if (this.options_.title) {
      ...
      menu$$1.children_.unshift(title);
      Dom.insertElFirst(title, menu$$1.contentEl());
    }
...
var trackButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var _menuButton2 = _interopRequireDefault(menuButton);
...
var MenuItem = function (_ClickableComponent) {
  ...
  MenuItem.prototype.createEl = function createEl(type, props, attrs) {
    ...
    return _ClickableComponent.prototype.createEl.call(this, 'li', (0, obj.assign)({
...
var textTrackMenuItem = createCommonjsModule(function (module, exports) {
'use strict';
...
var _menuItem2 = _interopRequireDefault(menuItem);
...
var offTextTrackMenuItem = createCommonjsModule(function (module, exports) {
'use strict';
...
var _textTrackMenuItem2 = _interopRequireDefault(textTrackMenuItem);
...
var textTrackButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var _trackButton2 = _interopRequireDefault(trackButton);
...
var _offTextTrackMenuItem2 = _interopRequireDefault(offTextTrackMenuItem);
...
var chaptersTrackMenuItem = createCommonjsModule(function (module, exports) {
'use strict';
...
var chaptersButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var _textTrackButton2 = _interopRequireDefault(textTrackButton);
...
var _chaptersTrackMenuItem2 = _interopRequireDefault(chaptersTrackMenuItem);
...
var descriptionsButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var subtitlesButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var captionSettingsMenuItem = createCommonjsModule(function (module, exports) {
'use strict';
...
var captionsButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var _captionSettingsMenuItem2 = _interopRequireDefault(captionSettingsMenuItem);
...
var audioTrackMenuItem = createCommonjsModule(function (module, exports) {
'use strict';
...
var audioTrackButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var _audioTrackMenuItem2 = _interopRequireDefault(audioTrackMenuItem);
...
var playbackRateMenuItem = createCommonjsModule(function (module, exports) {
'use strict';
...
var playbackRateMenuButton = createCommonjsModule(function (module, exports) {
'use strict';
...
var _playbackRateMenuItem2 = _interopRequireDefault(playbackRateMenuItem);
...
var PlaybackRateMenuButton = function (_MenuButton) {
  ...
  PlaybackRateMenuButton.prototype.createMenu = function createMenu() {
    var menu$$1 = new _menu2['default'](this.player());
    var rates = this.playbackRates();

    if (rates) {
      for (var i = rates.length - 1; i >= 0; i--) {
        menu$$1.addChild(new _playbackRateMenuItem2['default'](this.player(), { rate: rates[i] + 'x' }));
      }
    }
...
var spacer = createCommonjsModule(function (module, exports) {
'use strict';
...
var customControlSpacer = createCommonjsModule(function (module, exports) {
'use strict';
...
var _spacer2 = _interopRequireDefault(spacer);
...
var controlBar = createCommonjsModule(function (module, exports) {
'use strict';
...
var errorDisplay = createCommonjsModule(function (module, exports) {
'use strict';
...
var _modalDialog2 = _interopRequireDefault(modalDialog);
...
var textTrackSettings = createCommonjsModule(function (module, exports) {
'use strict';
...
var Obj = _interopRequireWildcard(obj);
...
var TextTrackSettings = function (_Component) {
  ...
  TextTrackSettings.prototype.createElSelect_ = function createElSelect_(key) {
    ...
    return [(0, dom.createEl)('label', {
      className: 'vjs-label',
      textContent: config.label
    }, {
      'for': id
    }), (0, dom.createEl)('select', { id: id }, undefined, config.options.map(function (o) {
      return (0, dom.createEl)('option', {
  ...
  TextTrackSettings.prototype.createElFgColor_ = function createElFgColor_() {
    var legend = (0, dom.createEl)('legend', {
      textContent: this.localize('Text')
    });

    var select = this.createElSelect_('color');

    var opacity = (0, dom.createEl)('span', {
      className: 'vjs-text-opacity vjs-opacity'
    }, undefined, this.createElSelect_('textOpacity'));

    return (0, dom.createEl)('fieldset', {
  ...
  TextTrackSettings.prototype.createElFont_ = function createElFont_() {
    var fontPercent = (0, dom.createEl)('div', {
      className: 'vjs-font-percent vjs-tracksetting'
    }, undefined, this.createElSelect_('fontPercent'));

    var edgeStyle = (0, dom.createEl)('div', {
      className: 'vjs-edge-style vjs-tracksetting'
    }, undefined, this.createElSelect_('edgeStyle'));

    var fontFamily = (0, dom.createEl)('div', {
  ...
  TextTrackSettings.prototype.createElControls_ = function createElControls_() {
    var defaultsButton = (0, dom.createEl)('button', {
      className: 'vjs-default-button',
      textContent: this.localize('Defaults')
    });

    var doneButton = (0, dom.createEl)('button', {
  ...
  TextTrackSettings.prototype.createEl = function createEl() {
    ...
    var description = (0, dom.createEl)('div', {
      className: 'vjs-control-text',
      id: 'TTsettingsDialogDescription-' + this.id_,
      textContent: 'Beginning of dialog window. Escape will cancel and close the window.'
    });

    var doc = (0, dom.createEl)('div', undefined, {
      role: 'document'
...
var html5 = createCommonjsModule(function (module, exports) {
'use strict';
...
var Html5 = function (_Tech) {
  ...
  function Html5(options, ready) {
    ...
    if ((browser$$1.TOUCH_ENABLED || browser$$1.IS_IPHONE || browser$$1.IS_NATIVE_ANDROID) && options.nativeControlsForTouch === true) {
  ...
  Html5.prototype.createEl = function createEl() {
    ...
    if (!el || !(this.options_.playerElIngest || this.movingMediaElementInDOM)) {
      ...
      if (el) {
        ...
        if (!browser$$1.TOUCH_ENABLED || this.options_.nativeControlsForTouch !== true) {
          delete attributes.controls;
        }

        Dom.setElAttributes(el, (0, obj.assign)(attributes, {
  ...
  Html5.prototype.duration = function duration() {
    ...
    if (this.el_.duration === Infinity && browser$$1.IS_ANDROID && browser$$1.IS_CHROME) {
...
Html5.canControlPlaybackRate = function () {
  ...
  if (browser$$1.IS_ANDROID && browser$$1.IS_CHROME) {
    return false;
  }
  // IE will error if Windows Media Player not installed #3315
  try {
...
Html5.supportsNativeTextTracks = function () {
  return browser$$1.IS_ANY_SAFARI;
};
 ...
 * @default
 */
Html5.prototype.movingMediaElementInDOM = !browser$$1.IS_IOS;
...
Html5.patchCanPlayType = function () {
  ...
  if (browser$$1.ANDROID_VERSION >= 4.0 && !browser$$1.IS_FIREFOX) {
  ...
  } else if (browser$$1.IS_OLD_ANDROID) {
    Html5.TEST_VID.constructor.prototype.canPlayType = function (type) {
 ...
 *        The options to pass to the source
 */
Html5.nativeSourceHandler.handleSource = function (source, tech$$1, options) {
  tech$$1.setSrc(source.src);
};
...
var stylesheet$$1 = _interopRequireWildcard(stylesheet);



var _fullscreenApi2 = _interopRequireDefault(fullscreenApi);
...
var _tuple2 = _interopRequireDefault(tuple);
...
var _textTrackListConverter2 = _interopRequireDefault(textTrackListConverter);
...
var Player = function (_Component) {
  ...
  function Player(tag, options, ready) {
    ...
    options = (0, obj.assign)(Player.getTagSettings(tag), options);
  ...
  Player.prototype.createEl = function createEl() {
    ...
    if (_window2['default'].VIDEOJS_NO_DYNAMIC_STYLE !== true) {
      this.styleEl_ = stylesheet$$1.createStyleElement('vjs-styles-dimensions');
  ...
  Player.prototype.updateStyleEl_ = function updateStyleEl_() {
    ...
    stylesheet$$1.setTextContent(this.styleEl_, '\n      .' + idClass + ' {\n        width: ' + width + 'px;\n        height: ' + height + 'px;\n      }\n\n      .' + idClass + '.vjs-fluid {\n        padding-top: ' + ratioMultiplier * 100 + '%;\n      }\n    ');
  };
  ...
  Player.prototype.tech = function tech$$1(safety) {
  ...
  Player.prototype.bufferedPercent = function bufferedPercent() {
    return (0, buffer.bufferedPercent)(this.buffered(), this.duration());
  };
  ...
  Player.prototype.canPlayType = function canPlayType(type) {
    ...
    for (var i = 0, j = this.options_.techOrder; i < j.length; i++) {
      ...
      // Check if the browser supports this technology
      if (tech$$1.isSupported()) {
        can = tech$$1.canPlayType(type);
  ...
  Player.prototype.selectSource = function selectSource(sources) {
    ...
    var finder = function finder(_ref2, source) {
      ...
      if (tech$$1.canPlaySource(source, _this4.options_[techName.toLowerCase()])) {
  ...
  Player.getTagSettings = function getTagSettings(tag) {
    ...
    if (dataSetup !== null) {
      ...
      (0, obj.assign)(tagOptions, data);
    }

    (0, obj.assign)(baseOptions, tagOptions);
 ...
 */
'readyState'].forEach(function (fn$$1) {
  Player.prototype[fn$$1] = function () {
    return this.techGet_(fn$$1);
  };
});
...
var _player2 = _interopRequireDefault(player);
...
var AudioTrack = function (_Track) {
  ...
  function AudioTrack() {
    ...
    var settings = (0, _mergeOptions2['default'])(options, {
      kind: trackEnums.AudioTrackKind[options.kind] || ''
    });
    // on IE8 this will be a document element
    // for every other browser this will be a normal object
    var track$$1 = (_this = _possibleConstructorReturn(this, _Track.call(this, settings)), _this);
    var enabled = false;

    if (browser$$1.IS_IE8) {
      for (var prop in AudioTrack.prototype) {
        if (prop !== 'constructor') {
          track$$1[prop] = AudioTrack.prototype[prop];
        }
      }
    }
    /**
     ...
     */
    Object.defineProperty(track$$1, 'enabled', {
      get: function get() {
        return enabled;
      },
    ...
    // we keep it false
    if (settings.enabled) {
      track$$1.enabled = settings.enabled;
    }
    track$$1.loaded_ = true;

    return _ret = track$$1, _possibleConstructorReturn(_this, _ret);
  }
...
var videoTrack = createCommonjsModule(function (module, exports) {
'use strict';
...
var VideoTrack = function (_Track) {
  ...
  function VideoTrack() {
    ...
    var settings = (0, _mergeOptions2['default'])(options, {
      kind: trackEnums.VideoTrackKind[options.kind] || ''
    });
    ...
    if (browser$$1.IS_IE8) {
      for (var prop in VideoTrack.prototype) {
        if (prop !== 'constructor') {
          track$$1[prop] = VideoTrack.prototype[prop];
        }
      }
    }
     ...
     * @fires VideoTrack#selectedchange
     */
    Object.defineProperty(track$$1, 'selected', {
      get: function get() {
        return selected;
      },
    ...
    if (settings.selected) {
      track$$1.selected = settings.selected;
    }
...
var extend$1 = createCommonjsModule(function (module, exports) {
'use strict';

exports.__esModule = true;

var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj$$1) { return typeof obj$$1; } : function (obj$$1) { return obj$$1 && typeof Symbol === "function" && obj$$1.constructor === Symbol && obj$$1 !== Symbol.prototype ? "symbol" : typeof obj$$1; };
...
var extendFn = function extendFn(superClass) {
  ...
  if ((0, obj.isObject)(subClassMethods)) {
...
var setup$$1 = _interopRequireWildcard(setup);
...
var _plugins2 = _interopRequireDefault(plugins);



var _mergeOptions3 = _interopRequireDefault(mergeOptions_1);
...
var _audioTrack2 = _interopRequireDefault(audioTrack);



var _videoTrack2 = _interopRequireDefault(videoTrack);
...
var _extend2 = _interopRequireDefault(extend$1);
...
function videojs(id, options, ready) {
  ...
  videojs.hooks('beforesetup').forEach(function (hookFunction) {
    ...
    if (!(0, obj.isObject)(opts) || Array.isArray(opts)) {
  ...
  var player$$1 = new PlayerComponent(tag, options, ready);

  videojs.hooks('setup').forEach(function (hookFunction) {
    return hookFunction(player$$1);
  });
 ...
 */
videojs.hooks = function (type, fn$$1) {
  videojs.hooks_[type] = videojs.hooks_[type] || [];
  if (fn$$1) {
    videojs.hooks_[type] = videojs.hooks_[type].concat(fn$$1);
  }
 ...
 */
videojs.hook = function (type, fn$$1) {
  videojs.hooks(type, fn$$1);
};
 ...
 */
videojs.removeHook = function (type, fn$$1) {
  var index$$1 = videojs.hooks(type).indexOf(fn$$1);
...
if (_window2['default'].VIDEOJS_NO_DYNAMIC_STYLE !== true && Dom.isReal()) {
  ...
  if (!style) {
    style = stylesheet$$1.createStyleElement('vjs-styles-defaults');
    var head = Dom.$('head');

    if (head) {
      head.insertBefore(style, head.firstChild);
    }
    stylesheet$$1.setTextContent(style, '\n      .video-js {\n        width: 300px;\n        height: 150px;\n      }\n\n      .vjs-fluid {\n        padding-top: 56.25%\n      }\n    ');
  }
}
...
setup$$1.autoSetupTimeout(1, videojs);
 ...
 * @type {boolean}
 */
videojs.TOUCH_ENABLED = browser$$1.TOUCH_ENABLED;
...
if (typeof undefined === 'function' && undefined.amd) {
  undefined('videojs', [], function () {
    return videojs;
  });

  // checking that module is an object too because of umdjs/umd#35
} else if ((_typeof(exports)) === 'object' && (_typeof(module)) === 'object') {
...
var videojs = unwrapExports(video);
